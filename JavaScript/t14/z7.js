...
if(users[i].email.includes(`bigmir`) == true){
    ...
    <tr>
				...
				<td class="centered"> <img src="${users[i].gender}.svg" class="icon icon_${users[i].gender}"> </td>
				
				<td>${users[i].email}</td>
				
            
				<td class="centered"> <input type="checkbox" ${checkbox}> </td>
			</tr>
    `
}
} 
tbody.innerHTML = users_html;